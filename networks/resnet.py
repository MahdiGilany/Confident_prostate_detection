...
## code from https://github.com/aredier/monte_carlo_dropout/blob/5271f0b45c855958a243e997c1d6860dc6ee874e/monte_carlo_dropout/resnet.py
class DropoutBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.bn1(out)
        out = self.relu(out)
        out = F.dropout(out, p=self.dropout_rate, training=self.training or self.force_dropout)
        out = self.conv2(out)
        out = self.bn2(out)
...
if __name__ == "__main__":
    ...
    net = resnet10(num_classes=2, in_channels=1, drop_rate='none')
